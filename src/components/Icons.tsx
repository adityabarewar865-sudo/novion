...
export function NovionLogo({ className = "w-10 h-10" }: { className?: string }) {
  return (
    <div className={`relative flex items-center justify-center shrink-0 ${className}`}>
      <div className="w-full h-full rounded-xl overflow-hidden border border-cyan-400/40 shadow-[0_0_15px_rgba(0,210,255,0.4)] bg-slate-950 relative group">
